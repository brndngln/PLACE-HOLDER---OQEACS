-- OMNI QUANTUM ELITE - FINANCIAL DATABASE SCHEMA
-- Consolidated schema aligned with SQL usage in financial/*.py
...
CREATE TABLE IF NOT EXISTS tax_reserves (
    ...
    UNIQUE(org_id, tax_year, quarter)
);
...
-- Invoice and collections module
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_bank_accounts_org_status ON bank_accounts(org_id, status);
CREATE INDEX IF NOT EXISTS idx_transactions_org_created_at ON transactions(org_id, created_at);
CREATE INDEX IF NOT EXISTS idx_transactions_customer ON transactions(customer_id);
CREATE INDEX IF NOT EXISTS idx_tax_reserves_org_year_quarter ON tax_reserves(org_id, tax_year, quarter);
CREATE INDEX IF NOT EXISTS idx_tax_events_org_created_at ON tax_events(org_id, created_at);
...
CREATE INDEX IF NOT EXISTS idx_scheduled_tax_payments_org_year ON scheduled_tax_payments(org_id, tax_year);
