...
include:
  ...
  # Tier 3 - Enhanced Infrastructure
  - path: systems/system-29-enhanced-monitoring/docker-compose.yml
  - path: systems/system-30-enhanced-logging/docker-compose.yml
  # ... etc
  
  # Tier 4 - Orchestration
  - path: systems/system-37-master-orchestrator/docker-compose.yml
