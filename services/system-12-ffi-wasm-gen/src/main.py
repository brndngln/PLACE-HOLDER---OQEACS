'''omni-ffi-wasm-gen service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_ffi_wasm_gen_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_ffi_wasm_gen_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/ffi/generate", "operation": "ffi_generate_post"}, {"method": "POST", "path": "/api/v1/ffi/validate", "operation": "ffi_validate_post"}]
...
app = FastAPI(title="omni-ffi-wasm-gen", version="1.0.0", lifespan=lifespan)
