'''Async SDK client for omni-ffi-wasm-gen.'''
...
class FfiWasmGenClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-ffi-wasm-gen:9805", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/ffi/generate", payload or {})
