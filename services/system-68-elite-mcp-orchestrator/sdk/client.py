'''Async SDK client for omni-elite-mcp-orchestrator.'''
...
class EliteMcpOrchestratorClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-elite-mcp-orchestrator:9913", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/mcp/route", payload or {})
