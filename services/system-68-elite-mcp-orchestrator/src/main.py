'''omni-elite-mcp-orchestrator service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_mcp_orchestrator_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_mcp_orchestrator_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/mcp/route", "operation": "mcp_route_post"}, {"method": "GET", "path": "/api/v1/mcp/status", "operation": "mcp_status_get"}, {"method": "POST", "path": "/api/v1/mcp/reconcile", "operation": "mcp_reconcile_post"}]
...
app = FastAPI(title="omni-elite-mcp-orchestrator", version="1.0.0", lifespan=lifespan)
