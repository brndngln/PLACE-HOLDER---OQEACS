'''Configuration for omni-elite-mcp-orchestrator.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-mcp-orchestrator", alias="SERVICE_NAME")
    port: int = Field(default=9913, alias="SERVICE_PORT")
