'''omni-algo-selector service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_algo_selector_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_algo_selector_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/benchmark/run", "operation": "benchmark_run_post"}, {"method": "GET", "path": "/api/v1/benchmark/history", "operation": "benchmark_history_get"}]
...
app = FastAPI(title="omni-algo-selector", version="1.0.0", lifespan=lifespan)
