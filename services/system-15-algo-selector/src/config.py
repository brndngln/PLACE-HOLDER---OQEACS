'''Configuration for omni-algo-selector.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-algo-selector", alias="SERVICE_NAME")
    port: int = Field(default=9808, alias="SERVICE_PORT")
