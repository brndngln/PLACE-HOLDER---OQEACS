'''Configuration for omni-ebpf-forensics.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-ebpf-forensics", alias="SERVICE_NAME")
    port: int = Field(default=9895, alias="SERVICE_PORT")
