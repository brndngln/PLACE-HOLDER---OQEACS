'''omni-ebpf-forensics service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_ebpf_forensics_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_ebpf_forensics_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/ebpf/deploy-policy", "operation": "ebpf_deploy_policy_post"}, {"method": "GET", "path": "/api/v1/ebpf/events", "operation": "ebpf_events_get"}, {"method": "GET", "path": "/api/v1/ebpf/alerts", "operation": "ebpf_alerts_get"}]
...
app = FastAPI(title="omni-ebpf-forensics", version="1.0.0", lifespan=lifespan)
