'''omni-elite-architecture-rule-enforcement service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_architecture_rule_enforcement_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_architecture_rule_enforcement_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/rules/enforce", "operation": "rules_enforce_post"}, {"method": "GET", "path": "/api/v1/rules", "operation": "rules_get"}, {"method": "POST", "path": "/api/v1/rules/add", "operation": "rules_add_post"}]
...
app = FastAPI(title="omni-elite-architecture-rule-enforcement", version="1.0.0", lifespan=lifespan)
