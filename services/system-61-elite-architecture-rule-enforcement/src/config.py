'''Configuration for omni-elite-architecture-rule-enforcement.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-architecture-rule-enforcement", alias="SERVICE_NAME")
    port: int = Field(default=9906, alias="SERVICE_PORT")
