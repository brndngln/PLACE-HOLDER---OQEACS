'''Async SDK client for omni-semantic-diff.'''
...
class SemanticDiffClient:
    ...
    def __init__(self, base_url: str = "http://omni-semantic-diff:9882", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/diff/semantic", payload or {})
