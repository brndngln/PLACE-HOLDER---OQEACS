'''Configuration for omni-semantic-diff.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-semantic-diff", alias="SERVICE_NAME")
    port: int = Field(default=9882, alias="SERVICE_PORT")
