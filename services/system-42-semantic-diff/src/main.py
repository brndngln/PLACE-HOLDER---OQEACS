'''omni-semantic-diff service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_semantic_diff_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_semantic_diff_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/diff/semantic", "operation": "diff_semantic_post"}, {"method": "POST", "path": "/api/v1/diff/impact", "operation": "diff_impact_post"}]
...
app = FastAPI(title="omni-semantic-diff", version="1.0.0", lifespan=lifespan)
