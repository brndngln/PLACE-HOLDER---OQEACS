'''Configuration for omni-elite-dependency-existence-validation.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-dependency-existence-validation", alias="SERVICE_NAME")
    port: int = Field(default=9905, alias="SERVICE_PORT")
