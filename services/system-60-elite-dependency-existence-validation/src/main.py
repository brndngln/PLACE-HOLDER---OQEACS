'''omni-elite-dependency-existence-validation service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_dependency_existence_validation_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_dependency_existence_validation_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/deps/validate", "operation": "deps_validate_post"}, {"method": "POST", "path": "/api/v1/deps/batch-validate", "operation": "deps_batch_validate_post"}, {"method": "GET", "path": "/api/v1/deps/stats", "operation": "deps_stats_get"}]
...
app = FastAPI(title="omni-elite-dependency-existence-validation", version="1.0.0", lifespan=lifespan)
