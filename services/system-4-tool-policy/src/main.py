'''omni-tool-policy service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_tool_policy_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_tool_policy_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/policy/recommend", "operation": "policy_recommend_post"}, {"method": "POST", "path": "/api/v1/policy/feedback", "operation": "policy_feedback_post"}, {"method": "GET", "path": "/api/v1/policy/stats", "operation": "policy_stats_get"}]
...
app = FastAPI(title="omni-tool-policy", version="1.0.0", lifespan=lifespan)
