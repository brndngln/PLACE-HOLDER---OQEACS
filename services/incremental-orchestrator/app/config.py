...
class Settings(BaseSettings):
    ...
    service_name: str = "incremental-orchestrator"
    service_port: int = 9628
    version: str = "1.0.0"
    log_level: str = "info"
    log_format: str = "json"
    database_url: str = ""
    ...
    qdrant_collection: str = "incremental-orchestrator"
    ...
    minio_bucket: str = "gi-incremental-orchestrator"
