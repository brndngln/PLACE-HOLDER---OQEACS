'''Configuration for omni-escalation-router.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-escalation-router", alias="SERVICE_NAME")
    port: int = Field(default=9855, alias="SERVICE_PORT")
