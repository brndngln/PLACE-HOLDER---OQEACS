'''omni-escalation-router service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_escalation_router_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_escalation_router_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/monitor/register", "operation": "monitor_register_post"}, {"method": "GET", "path": "/api/v1/monitor/{task_id}/status", "operation": "monitor_task_id_status_get"}, {"method": "POST", "path": "/api/v1/monitor/{task_id}/resolve", "operation": "monitor_task_id_resolve_post"}]
...
app = FastAPI(title="omni-escalation-router", version="1.0.0", lifespan=lifespan)
