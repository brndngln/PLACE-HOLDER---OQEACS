'''Async SDK client for omni-escalation-router.'''
...
class EscalationRouterClient:
    ...
    def __init__(self, base_url: str = "http://omni-escalation-router:9855", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/monitor/register", payload or {})
