'''Configuration for omni-elite-tier2-fast-verification.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-tier2-fast-verification", alias="SERVICE_NAME")
    port: int = Field(default=9903, alias="SERVICE_PORT")
