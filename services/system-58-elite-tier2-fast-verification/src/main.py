'''omni-elite-tier2-fast-verification service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_tier2_fast_verification_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_tier2_fast_verification_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/verify/tier2", "operation": "verify_tier2_post"}, {"method": "GET", "path": "/api/v1/verify/tier2/{job_id}/status", "operation": "verify_tier2_job_id_status_get"}, {"method": "GET", "path": "/api/v1/verify/tier2/{job_id}/report", "operation": "verify_tier2_job_id_report_get"}]
...
app = FastAPI(title="omni-elite-tier2-fast-verification", version="1.0.0", lifespan=lifespan)
