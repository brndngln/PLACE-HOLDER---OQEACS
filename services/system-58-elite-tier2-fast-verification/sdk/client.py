'''Async SDK client for omni-elite-tier2-fast-verification.'''
...
class EliteTier2FastVerificationClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-elite-tier2-fast-verification:9903", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/verify/tier2", payload or {})
