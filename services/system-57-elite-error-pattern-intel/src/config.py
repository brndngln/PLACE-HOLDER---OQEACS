'''Configuration for omni-elite-error-pattern-intel.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-error-pattern-intel", alias="SERVICE_NAME")
    port: int = Field(default=9902, alias="SERVICE_PORT")
