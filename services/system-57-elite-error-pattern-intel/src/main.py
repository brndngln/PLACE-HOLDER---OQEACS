'''omni-elite-error-pattern-intel service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_error_pattern_intel_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_error_pattern_intel_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/error-patterns/ingest", "operation": "error_patterns_ingest_post"}, {"method": "GET", "path": "/api/v1/error-patterns/search", "operation": "error_patterns_search_get"}, {"method": "GET", "path": "/api/v1/error-patterns/stats", "operation": "error_patterns_stats_get"}]
...
app = FastAPI(title="omni-elite-error-pattern-intel", version="1.0.0", lifespan=lifespan)
