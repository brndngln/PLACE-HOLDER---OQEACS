'''omni-rca-synth service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_rca_synth_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_rca_synth_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/rca/analyze", "operation": "rca_analyze_post"}, {"method": "GET", "path": "/api/v1/rca/{analysis_id}/evidence", "operation": "rca_analysis_id_evidence_get"}]
...
app = FastAPI(title="omni-rca-synth", version="1.0.0", lifespan=lifespan)
