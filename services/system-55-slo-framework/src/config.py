'''Configuration for omni-slo-framework.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-slo-framework", alias="SERVICE_NAME")
    port: int = Field(default=9897, alias="SERVICE_PORT")
