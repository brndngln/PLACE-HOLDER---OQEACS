'''omni-slo-framework service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_slo_framework_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_slo_framework_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "GET", "path": "/api/v1/slo/services", "operation": "slo_services_get"}, {"method": "GET", "path": "/api/v1/slo/{service}/budget", "operation": "slo_service_budget_get"}, {"method": "POST", "path": "/api/v1/slo/{service}/configure", "operation": "slo_service_configure_post"}, {"method": "GET", "path": "/api/v1/slo/alerts", "operation": "slo_alerts_get"}]
...
app = FastAPI(title="omni-slo-framework", version="1.0.0", lifespan=lifespan)
