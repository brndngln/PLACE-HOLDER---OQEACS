'''omni-minrepro service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_minrepro_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_minrepro_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/repro/minimize", "operation": "repro_minimize_post"}, {"method": "GET", "path": "/api/v1/repro/{id}/result", "operation": "repro_id_result_get"}]
...
app = FastAPI(title="omni-minrepro", version="1.0.0", lifespan=lifespan)
