'''Configuration for omni-context-compress.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-context-compress", alias="SERVICE_NAME")
    port: int = Field(default=9845, alias="SERVICE_PORT")
