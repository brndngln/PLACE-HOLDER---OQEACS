'''omni-context-compress service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_context_compress_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_context_compress_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/compress", "operation": "compress_post"}, {"method": "GET", "path": "/api/v1/compress/stats", "operation": "compress_stats_get"}]
...
app = FastAPI(title="omni-context-compress", version="1.0.0", lifespan=lifespan)
