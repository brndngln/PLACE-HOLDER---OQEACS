'''Configuration for omni-elite-database-intelligence.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-database-intelligence", alias="SERVICE_NAME")
    port: int = Field(default=9911, alias="SERVICE_PORT")
