'''omni-elite-database-intelligence service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_database_intelligence_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_database_intelligence_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/database/analyze", "operation": "database_analyze_post"}, {"method": "POST", "path": "/api/v1/database/migration-check", "operation": "database_migration_check_post"}, {"method": "GET", "path": "/api/v1/database/stats", "operation": "database_stats_get"}]
...
app = FastAPI(title="omni-elite-database-intelligence", version="1.0.0", lifespan=lifespan)
