'''omni-vuln-graph service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_vuln_graph_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_vuln_graph_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/vuln/scan", "operation": "vuln_scan_post"}, {"method": "GET", "path": "/api/v1/vuln/advisory/{cve_id}", "operation": "vuln_advisory_cve_id_get"}, {"method": "POST", "path": "/api/v1/vuln/sync", "operation": "vuln_sync_post"}, {"method": "GET", "path": "/api/v1/vuln/stats", "operation": "vuln_stats_get"}]
...
app = FastAPI(title="omni-vuln-graph", version="1.0.0", lifespan=lifespan)
