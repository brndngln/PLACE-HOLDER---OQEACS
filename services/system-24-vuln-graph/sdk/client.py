'''Async SDK client for omni-vuln-graph.'''
...
class VulnGraphClient:
    ...
    def __init__(self, base_url: str = "http://omni-vuln-graph:9841", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/vuln/scan", payload or {})
