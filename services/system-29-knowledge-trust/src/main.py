'''omni-knowledge-trust service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_knowledge_trust_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_knowledge_trust_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/trust/score-chunks", "operation": "trust_score_chunks_post"}, {"method": "POST", "path": "/api/v1/trust/configure", "operation": "trust_configure_post"}]
...
app = FastAPI(title="omni-knowledge-trust", version="1.0.0", lifespan=lifespan)
