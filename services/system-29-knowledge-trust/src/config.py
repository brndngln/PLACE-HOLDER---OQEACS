'''Configuration for omni-knowledge-trust.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-knowledge-trust", alias="SERVICE_NAME")
    port: int = Field(default=9846, alias="SERVICE_PORT")
