'''omni-iot-pack service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_iot_pack_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_iot_pack_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/iot/generate", "operation": "iot_generate_post"}, {"method": "POST", "path": "/api/v1/iot/simulate", "operation": "iot_simulate_post"}, {"method": "POST", "path": "/api/v1/iot/validate", "operation": "iot_validate_post"}]
...
app = FastAPI(title="omni-iot-pack", version="1.0.0", lifespan=lifespan)
