'''Async SDK client for omni-iot-pack.'''
...
class IotPackClient:
    ...
    def __init__(self, base_url: str = "http://omni-iot-pack:9861", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/iot/generate", payload or {})
