'''omni-desktop-pack service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_desktop_pack_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_desktop_pack_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/desktop/generate", "operation": "desktop_generate_post"}, {"method": "POST", "path": "/api/v1/desktop/build", "operation": "desktop_build_post"}, {"method": "POST", "path": "/api/v1/desktop/sign", "operation": "desktop_sign_post"}]
...
app = FastAPI(title="omni-desktop-pack", version="1.0.0", lifespan=lifespan)
