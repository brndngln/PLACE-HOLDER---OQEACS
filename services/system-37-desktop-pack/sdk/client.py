'''Async SDK client for omni-desktop-pack.'''
...
class DesktopPackClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-desktop-pack:9865", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/desktop/generate", payload or {})
