'''omni-elite-cross-repo-intel service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_cross_repo_intel_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_cross_repo_intel_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/cross-repo/analyze", "operation": "cross_repo_analyze_post"}, {"method": "GET", "path": "/api/v1/cross-repo/{id}/status", "operation": "cross_repo_id_status_get"}, {"method": "GET", "path": "/api/v1/cross-repo/{id}/impact", "operation": "cross_repo_id_impact_get"}]
...
app = FastAPI(title="omni-elite-cross-repo-intel", version="1.0.0", lifespan=lifespan)
