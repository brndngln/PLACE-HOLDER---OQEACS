'''Configuration for omni-elite-cross-repo-intel.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-cross-repo-intel", alias="SERVICE_NAME")
    port: int = Field(default=9907, alias="SERVICE_PORT")
