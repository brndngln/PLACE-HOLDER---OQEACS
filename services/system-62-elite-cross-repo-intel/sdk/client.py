'''Async SDK client for omni-elite-cross-repo-intel.'''
...
class EliteCrossRepoIntelClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-elite-cross-repo-intel:9907", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/cross-repo/analyze", payload or {})
