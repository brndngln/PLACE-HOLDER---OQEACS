'''Async SDK client for omni-redteam-agent.'''
...
class RedteamAgentClient:
    ...
    def __init__(self, base_url: str = "http://omni-redteam-agent:9857", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/redteam/scan", payload or {})
