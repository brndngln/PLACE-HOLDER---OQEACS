'''omni-redteam-agent service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_redteam_agent_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_redteam_agent_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/redteam/scan", "operation": "redteam_scan_post"}, {"method": "GET", "path": "/api/v1/redteam/{scan_id}/findings", "operation": "redteam_scan_id_findings_get"}, {"method": "POST", "path": "/api/v1/redteam/{scan_id}/retest", "operation": "redteam_scan_id_retest_post"}]
...
app = FastAPI(title="omni-redteam-agent", version="1.0.0", lifespan=lifespan)
