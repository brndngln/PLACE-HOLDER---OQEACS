'''Configuration for omni-redteam-agent.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-redteam-agent", alias="SERVICE_NAME")
    port: int = Field(default=9857, alias="SERVICE_PORT")
