'''Async SDK client for omni-elt-pack.'''
...
class EltPackClient:
    ...
    def __init__(self, base_url: str = "http://omni-elt-pack:9870", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/elt/generate", payload or {})
