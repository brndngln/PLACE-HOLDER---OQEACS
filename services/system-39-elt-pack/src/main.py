'''omni-elt-pack service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elt_pack_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elt_pack_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/elt/generate", "operation": "elt_generate_post"}, {"method": "POST", "path": "/api/v1/elt/validate", "operation": "elt_validate_post"}]
...
app = FastAPI(title="omni-elt-pack", version="1.0.0", lifespan=lifespan)
