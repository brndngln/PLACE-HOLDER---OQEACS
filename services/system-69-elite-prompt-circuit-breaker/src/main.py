'''omni-elite-prompt-circuit-breaker service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_prompt_circuit_breaker_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_prompt_circuit_breaker_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/circuit/evaluate", "operation": "circuit_evaluate_post"}, {"method": "POST", "path": "/api/v1/circuit/open", "operation": "circuit_open_post"}, {"method": "GET", "path": "/api/v1/circuit/state", "operation": "circuit_state_get"}]
...
app = FastAPI(title="omni-elite-prompt-circuit-breaker", version="1.0.0", lifespan=lifespan)
