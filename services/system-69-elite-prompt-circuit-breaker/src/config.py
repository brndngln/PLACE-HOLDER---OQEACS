'''Configuration for omni-elite-prompt-circuit-breaker.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-prompt-circuit-breaker", alias="SERVICE_NAME")
    port: int = Field(default=9914, alias="SERVICE_PORT")
