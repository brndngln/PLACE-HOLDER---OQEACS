'''Async SDK client for omni-elite-prompt-circuit-breaker.'''
...
class ElitePromptCircuitBreakerClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-elite-prompt-circuit-breaker:9914", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/circuit/evaluate", payload or {})
