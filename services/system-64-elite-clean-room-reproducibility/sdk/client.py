'''Async SDK client for omni-elite-clean-room-reproducibility.'''
...
class EliteCleanRoomReproducibilityClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-elite-clean-room-reproducibility:9909", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/repro/build", payload or {})
