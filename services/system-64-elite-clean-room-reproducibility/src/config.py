'''Configuration for omni-elite-clean-room-reproducibility.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-clean-room-reproducibility", alias="SERVICE_NAME")
    port: int = Field(default=9909, alias="SERVICE_PORT")
