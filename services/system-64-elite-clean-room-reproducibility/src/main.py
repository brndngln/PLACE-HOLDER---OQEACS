'''omni-elite-clean-room-reproducibility service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_clean_room_reproducibility_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_clean_room_reproducibility_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/repro/build", "operation": "repro_build_post"}, {"method": "GET", "path": "/api/v1/repro/{id}/status", "operation": "repro_id_status_get"}, {"method": "GET", "path": "/api/v1/repro/{id}/diff", "operation": "repro_id_diff_get"}]
...
app = FastAPI(title="omni-elite-clean-room-reproducibility", version="1.0.0", lifespan=lifespan)
