'''omni-elite-runtime-drift-detector service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_runtime_drift_detector_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_runtime_drift_detector_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/drift/baseline", "operation": "drift_baseline_post"}, {"method": "POST", "path": "/api/v1/drift/check", "operation": "drift_check_post"}, {"method": "GET", "path": "/api/v1/drift/alerts", "operation": "drift_alerts_get"}]
...
app = FastAPI(title="omni-elite-runtime-drift-detector", version="1.0.0", lifespan=lifespan)
