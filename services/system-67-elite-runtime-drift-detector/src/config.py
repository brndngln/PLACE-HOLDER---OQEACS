'''Configuration for omni-elite-runtime-drift-detector.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-runtime-drift-detector", alias="SERVICE_NAME")
    port: int = Field(default=9912, alias="SERVICE_PORT")
