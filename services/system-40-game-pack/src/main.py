'''omni-game-pack service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_game_pack_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_game_pack_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/game/generate", "operation": "game_generate_post"}, {"method": "POST", "path": "/api/v1/game/test", "operation": "game_test_post"}]
...
app = FastAPI(title="omni-game-pack", version="1.0.0", lifespan=lifespan)
