'''Async SDK client for omni-elite-semantic-intent-verification.'''
...
class EliteSemanticIntentVerificationClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-elite-semantic-intent-verification:9904", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/intent/verify", payload or {})
