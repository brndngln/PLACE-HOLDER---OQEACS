'''Configuration for omni-elite-semantic-intent-verification.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-semantic-intent-verification", alias="SERVICE_NAME")
    port: int = Field(default=9904, alias="SERVICE_PORT")
