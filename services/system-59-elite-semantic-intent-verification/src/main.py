'''omni-elite-semantic-intent-verification service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_semantic_intent_verification_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_semantic_intent_verification_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/intent/verify", "operation": "intent_verify_post"}, {"method": "GET", "path": "/api/v1/intent/{id}/status", "operation": "intent_id_status_get"}, {"method": "GET", "path": "/api/v1/intent/{id}/evidence", "operation": "intent_id_evidence_get"}]
...
app = FastAPI(title="omni-elite-semantic-intent-verification", version="1.0.0", lifespan=lifespan)
