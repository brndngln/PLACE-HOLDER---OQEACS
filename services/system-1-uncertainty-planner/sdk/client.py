'''Async SDK client for omni-uncertainty-planner.'''
...
class UncertaintyPlannerClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-uncertainty-planner:9851", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/plan/evaluate", payload or {})
