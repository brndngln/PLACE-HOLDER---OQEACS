'''Configuration for omni-uncertainty-planner.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-uncertainty-planner", alias="SERVICE_NAME")
    port: int = Field(default=9851, alias="SERVICE_PORT")
