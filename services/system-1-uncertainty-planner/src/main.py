'''omni-uncertainty-planner service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_uncertainty_planner_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_uncertainty_planner_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/plan/evaluate", "operation": "plan_evaluate_post"}, {"method": "POST", "path": "/api/v1/plan/calibrate", "operation": "plan_calibrate_post"}, {"method": "GET", "path": "/api/v1/plan/thresholds", "operation": "plan_thresholds_get"}]
...
app = FastAPI(title="omni-uncertainty-planner", version="1.0.0", lifespan=lifespan)
