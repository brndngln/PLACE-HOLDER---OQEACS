'''Async SDK client for omni-lineage-explorer.'''
...
class LineageExplorerClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-lineage-explorer:9881", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("GET", "/api/v1/lineage/sample", payload or {})
