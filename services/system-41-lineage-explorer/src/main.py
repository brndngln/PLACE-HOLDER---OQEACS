'''omni-lineage-explorer service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_lineage_explorer_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_lineage_explorer_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "GET", "path": "/api/v1/lineage/{task_id}", "operation": "lineage_task_id_get"}, {"method": "GET", "path": "/api/v1/lineage/{task_id}/artifact/{artifact_id}", "operation": "lineage_task_id_artifact_artifact_id_get"}, {"method": "GET", "path": "/api/v1/lineage/search", "operation": "lineage_search_get"}]
...
app = FastAPI(title="omni-lineage-explorer", version="1.0.0", lifespan=lifespan)
