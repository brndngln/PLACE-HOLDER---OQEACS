'''Configuration for omni-lineage-explorer.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-lineage-explorer", alias="SERVICE_NAME")
    port: int = Field(default=9881, alias="SERVICE_PORT")
