'''omni-fhir-pack service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_fhir_pack_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_fhir_pack_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/fhir/validate", "operation": "fhir_validate_post"}, {"method": "POST", "path": "/api/v1/fhir/generate", "operation": "fhir_generate_post"}, {"method": "GET", "path": "/api/v1/fhir/profiles", "operation": "fhir_profiles_get"}]
...
app = FastAPI(title="omni-fhir-pack", version="1.0.0", lifespan=lifespan)
