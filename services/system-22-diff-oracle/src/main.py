'''omni-diff-oracle service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_diff_oracle_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_diff_oracle_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/diff/record", "operation": "diff_record_post"}, {"method": "POST", "path": "/api/v1/diff/compare", "operation": "diff_compare_post"}, {"method": "GET", "path": "/api/v1/diff/{report_id}/details", "operation": "diff_report_id_details_get"}]
...
app = FastAPI(title="omni-diff-oracle", version="1.0.0", lifespan=lifespan)
