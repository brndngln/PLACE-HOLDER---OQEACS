'''Configuration for omni-native-fuzz-cluster.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-native-fuzz-cluster", alias="SERVICE_NAME")
    port: int = Field(default=9826, alias="SERVICE_PORT")
