'''omni-native-fuzz-cluster service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_native_fuzz_cluster_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_native_fuzz_cluster_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/fuzz/native/start", "operation": "fuzz_native_start_post"}, {"method": "GET", "path": "/api/v1/fuzz/native/{job_id}/crashes", "operation": "fuzz_native_job_id_crashes_get"}, {"method": "POST", "path": "/api/v1/fuzz/native/{job_id}/minimize", "operation": "fuzz_native_job_id_minimize_post"}]
...
app = FastAPI(title="omni-native-fuzz-cluster", version="1.0.0", lifespan=lifespan)
