'''omni-lsp-refactor service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_lsp_refactor_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_lsp_refactor_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/refactor/rename", "operation": "refactor_rename_post"}, {"method": "POST", "path": "/api/v1/refactor/extract-function", "operation": "refactor_extract_function_post"}, {"method": "POST", "path": "/api/v1/refactor/references", "operation": "refactor_references_post"}, {"method": "GET", "path": "/api/v1/servers/status", "operation": "servers_status_get"}]
...
app = FastAPI(title="omni-lsp-refactor", version="1.0.0", lifespan=lifespan)
