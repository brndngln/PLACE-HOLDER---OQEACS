'''Async SDK client for omni-lsp-refactor.'''
...
class LspRefactorClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-lsp-refactor:9801", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/refactor/rename", payload or {})
