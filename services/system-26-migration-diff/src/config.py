'''Configuration for omni-migration-diff.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-migration-diff", alias="SERVICE_NAME")
    port: int = Field(default=9843, alias="SERVICE_PORT")
