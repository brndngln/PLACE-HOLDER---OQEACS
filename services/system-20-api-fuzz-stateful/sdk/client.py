'''Async SDK client for omni-api-fuzz-stateful.'''
...
class ApiFuzzStatefulClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-api-fuzz-stateful:9825", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/fuzz/start", payload or {})
