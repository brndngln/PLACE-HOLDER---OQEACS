'''omni-api-fuzz-stateful service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_api_fuzz_stateful_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_api_fuzz_stateful_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/fuzz/start", "operation": "fuzz_start_post"}, {"method": "GET", "path": "/api/v1/fuzz/{job_id}/status", "operation": "fuzz_job_id_status_get"}, {"method": "GET", "path": "/api/v1/fuzz/{job_id}/findings", "operation": "fuzz_job_id_findings_get"}, {"method": "GET", "path": "/api/v1/fuzz/{job_id}/regression-tests", "operation": "fuzz_job_id_regression_tests_get"}]
...
app = FastAPI(title="omni-api-fuzz-stateful", version="1.0.0", lifespan=lifespan)
