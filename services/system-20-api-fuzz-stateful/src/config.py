'''Configuration for omni-api-fuzz-stateful.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-api-fuzz-stateful", alias="SERVICE_NAME")
    port: int = Field(default=9825, alias="SERVICE_PORT")
