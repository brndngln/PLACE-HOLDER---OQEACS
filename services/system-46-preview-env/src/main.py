'''omni-preview-env service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_preview_env_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_preview_env_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/preview/create", "operation": "preview_create_post"}, {"method": "GET", "path": "/api/v1/preview/{id}/status", "operation": "preview_id_status_get"}, {"method": "DELETE", "path": "/api/v1/preview/{id}", "operation": "preview_id_delete"}, {"method": "GET", "path": "/api/v1/preview/active", "operation": "preview_active_get"}]
...
app = FastAPI(title="omni-preview-env", version="1.0.0", lifespan=lifespan)
