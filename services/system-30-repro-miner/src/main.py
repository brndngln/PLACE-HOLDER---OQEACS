'''omni-repro-miner service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_repro_miner_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_repro_miner_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/repro/minimize", "operation": "repro_minimize_post"}, {"method": "GET", "path": "/api/v1/repro/{id}/status", "operation": "repro_id_status_get"}]
...
app = FastAPI(title="omni-repro-miner", version="1.0.0", lifespan=lifespan)
