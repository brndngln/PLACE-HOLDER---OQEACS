'''Async SDK client for omni-repro-miner.'''
...
class ReproMinerClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-repro-miner:9847", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/repro/minimize", payload or {})
