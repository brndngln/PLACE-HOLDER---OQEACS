'''Configuration for omni-buildgraph-planner.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-buildgraph-planner", alias="SERVICE_NAME")
    port: int = Field(default=9802, alias="SERVICE_PORT")
