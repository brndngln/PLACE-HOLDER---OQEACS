'''omni-rag-eval service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_rag_eval_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_rag_eval_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/eval/run", "operation": "eval_run_post"}, {"method": "POST", "path": "/api/v1/eval/add-pair", "operation": "eval_add_pair_post"}, {"method": "GET", "path": "/api/v1/eval/history", "operation": "eval_history_get"}, {"method": "GET", "path": "/api/v1/eval/alerts", "operation": "eval_alerts_get"}]
...
app = FastAPI(title="omni-rag-eval", version="1.0.0", lifespan=lifespan)
