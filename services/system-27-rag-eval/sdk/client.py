'''Async SDK client for omni-rag-eval.'''
...
class RagEvalClient:
    ...
    def __init__(self, base_url: str = "http://omni-rag-eval:9844", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/eval/run", payload or {})
