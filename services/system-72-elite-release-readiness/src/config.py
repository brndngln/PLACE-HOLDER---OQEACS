'''Configuration for omni-elite-release-readiness.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-release-readiness", alias="SERVICE_NAME")
    port: int = Field(default=9917, alias="SERVICE_PORT")
