'''omni-elite-release-readiness service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_release_readiness_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_release_readiness_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/release/evaluate", "operation": "release_evaluate_post"}, {"method": "GET", "path": "/api/v1/release/{id}/status", "operation": "release_id_status_get"}, {"method": "GET", "path": "/api/v1/release/{id}/gates", "operation": "release_id_gates_get"}]
...
app = FastAPI(title="omni-elite-release-readiness", version="1.0.0", lifespan=lifespan)
