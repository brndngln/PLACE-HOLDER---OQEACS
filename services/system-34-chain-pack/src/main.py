'''omni-chain-pack service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_chain_pack_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_chain_pack_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/chain/generate", "operation": "chain_generate_post"}, {"method": "POST", "path": "/api/v1/chain/test", "operation": "chain_test_post"}, {"method": "POST", "path": "/api/v1/chain/audit", "operation": "chain_audit_post"}]
...
app = FastAPI(title="omni-chain-pack", version="1.0.0", lifespan=lifespan)
