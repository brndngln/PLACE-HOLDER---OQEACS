'''Async SDK client for omni-cost-optimizer.'''
...
class CostOptimizerClient:
    ...
    def __init__(self, base_url: str = "http://omni-cost-optimizer:9896", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("GET", "/api/v1/costs/summary", payload or {})
