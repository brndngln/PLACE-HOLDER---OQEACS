'''Configuration for omni-cost-optimizer.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-cost-optimizer", alias="SERVICE_NAME")
    port: int = Field(default=9896, alias="SERVICE_PORT")
