'''omni-cost-optimizer service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_cost_optimizer_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_cost_optimizer_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "GET", "path": "/api/v1/costs/summary", "operation": "costs_summary_get"}, {"method": "GET", "path": "/api/v1/costs/breakdown", "operation": "costs_breakdown_get"}, {"method": "POST", "path": "/api/v1/costs/optimize", "operation": "costs_optimize_post"}]
...
app = FastAPI(title="omni-cost-optimizer", version="1.0.0", lifespan=lifespan)
