'''Async SDK client for omni-query-plan-gen.'''
...
class QueryPlanGenClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-query-plan-gen:9807", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/analyze/query", payload or {})
