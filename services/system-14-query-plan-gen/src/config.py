'''Configuration for omni-query-plan-gen.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-query-plan-gen", alias="SERVICE_NAME")
    port: int = Field(default=9807, alias="SERVICE_PORT")
