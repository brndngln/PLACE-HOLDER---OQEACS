'''omni-query-plan-gen service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_query_plan_gen_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_query_plan_gen_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/analyze/query", "operation": "analyze_query_post"}, {"method": "POST", "path": "/api/v1/analyze/orm", "operation": "analyze_orm_post"}, {"method": "POST", "path": "/api/v1/suggest/indexes", "operation": "suggest_indexes_post"}]
...
app = FastAPI(title="omni-query-plan-gen", version="1.0.0", lifespan=lifespan)
