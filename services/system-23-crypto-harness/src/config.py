'''Configuration for omni-crypto-harness.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-crypto-harness", alias="SERVICE_NAME")
    port: int = Field(default=9828, alias="SERVICE_PORT")
