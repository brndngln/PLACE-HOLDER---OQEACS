'''omni-crypto-harness service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_crypto_harness_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_crypto_harness_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/crypto/verify", "operation": "crypto_verify_post"}, {"method": "GET", "path": "/api/v1/crypto/vectors/{algorithm}", "operation": "crypto_vectors_algorithm_get"}]
...
app = FastAPI(title="omni-crypto-harness", version="1.0.0", lifespan=lifespan)
