'''omni-mesh-identity service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_mesh_identity_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_mesh_identity_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/mesh/generate-identity", "operation": "mesh_generate_identity_post"}, {"method": "POST", "path": "/api/v1/mesh/generate-policy", "operation": "mesh_generate_policy_post"}, {"method": "GET", "path": "/api/v1/mesh/topology", "operation": "mesh_topology_get"}]
...
app = FastAPI(title="omni-mesh-identity", version="1.0.0", lifespan=lifespan)
