'''Configuration for omni-mesh-identity.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-mesh-identity", alias="SERVICE_NAME")
    port: int = Field(default=9893, alias="SERVICE_PORT")
