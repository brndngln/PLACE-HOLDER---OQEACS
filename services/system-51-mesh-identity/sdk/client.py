'''Async SDK client for omni-mesh-identity.'''
...
class MeshIdentityClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-mesh-identity:9893", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/mesh/generate-identity", payload or {})
