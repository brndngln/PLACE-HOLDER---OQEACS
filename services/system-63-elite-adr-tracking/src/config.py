'''Configuration for omni-elite-adr-tracking.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-adr-tracking", alias="SERVICE_NAME")
    port: int = Field(default=9908, alias="SERVICE_PORT")
