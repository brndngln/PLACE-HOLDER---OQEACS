'''omni-elite-adr-tracking service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_adr_tracking_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_adr_tracking_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/adr/register", "operation": "adr_register_post"}, {"method": "GET", "path": "/api/v1/adr/{id}", "operation": "adr_id_get"}, {"method": "GET", "path": "/api/v1/adr/search", "operation": "adr_search_get"}]
...
app = FastAPI(title="omni-elite-adr-tracking", version="1.0.0", lifespan=lifespan)
