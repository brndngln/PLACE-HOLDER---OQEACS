'''Async SDK client for omni-spec-clarifier.'''
...
class SpecClarifierClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-spec-clarifier:9856", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/clarify", payload or {})
