'''Configuration for omni-spec-clarifier.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-spec-clarifier", alias="SERVICE_NAME")
    port: int = Field(default=9856, alias="SERVICE_PORT")
