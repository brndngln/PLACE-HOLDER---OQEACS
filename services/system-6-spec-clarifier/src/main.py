'''omni-spec-clarifier service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_spec_clarifier_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_spec_clarifier_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/clarify", "operation": "clarify_post"}, {"method": "POST", "path": "/api/v1/clarify/answer", "operation": "clarify_answer_post"}]
...
app = FastAPI(title="omni-spec-clarifier", version="1.0.0", lifespan=lifespan)
