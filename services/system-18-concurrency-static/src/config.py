'''Configuration for omni-concurrency-static.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-concurrency-static", alias="SERVICE_NAME")
    port: int = Field(default=9823, alias="SERVICE_PORT")
