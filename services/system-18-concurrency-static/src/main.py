'''omni-concurrency-static service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_concurrency_static_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_concurrency_static_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/analyze/concurrency", "operation": "analyze_concurrency_post"}]
...
app = FastAPI(title="omni-concurrency-static", version="1.0.0", lifespan=lifespan)
