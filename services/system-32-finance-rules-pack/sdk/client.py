'''Async SDK client for omni-finance-rules-pack.'''
...
class FinanceRulesPackClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-finance-rules-pack:9868", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/finance/validate-code", payload or {})
