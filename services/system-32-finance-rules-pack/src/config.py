'''Configuration for omni-finance-rules-pack.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-finance-rules-pack", alias="SERVICE_NAME")
    port: int = Field(default=9868, alias="SERVICE_PORT")
