'''omni-finance-rules-pack service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_finance_rules_pack_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_finance_rules_pack_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/finance/validate-code", "operation": "finance_validate_code_post"}, {"method": "POST", "path": "/api/v1/finance/generate", "operation": "finance_generate_post"}, {"method": "GET", "path": "/api/v1/finance/rules/{jurisdiction}", "operation": "finance_rules_jurisdiction_get"}]
...
app = FastAPI(title="omni-finance-rules-pack", version="1.0.0", lifespan=lifespan)
