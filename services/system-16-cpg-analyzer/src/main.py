'''omni-cpg-analyzer service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_cpg_analyzer_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_cpg_analyzer_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/cpg/analyze", "operation": "cpg_analyze_post"}, {"method": "POST", "path": "/api/v1/cpg/query", "operation": "cpg_query_post"}]
...
app = FastAPI(title="omni-cpg-analyzer", version="1.0.0", lifespan=lifespan)
