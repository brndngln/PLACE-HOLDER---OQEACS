'''Async SDK client for omni-elite-architecture-fitness.'''
...
class EliteArchitectureFitnessClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-elite-architecture-fitness:9901", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/fitness/evaluate", payload or {})
