'''omni-elite-architecture-fitness service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_architecture_fitness_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_architecture_fitness_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/fitness/evaluate", "operation": "fitness_evaluate_post"}, {"method": "GET", "path": "/api/v1/fitness/{id}/status", "operation": "fitness_id_status_get"}, {"method": "GET", "path": "/api/v1/fitness/rules", "operation": "fitness_rules_get"}]
...
app = FastAPI(title="omni-elite-architecture-fitness", version="1.0.0", lifespan=lifespan)
