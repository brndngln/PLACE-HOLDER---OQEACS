'''Configuration for omni-progressive-delivery.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-progressive-delivery", alias="SERVICE_NAME")
    port: int = Field(default=9892, alias="SERVICE_PORT")
