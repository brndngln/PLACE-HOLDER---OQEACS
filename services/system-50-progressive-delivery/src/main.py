'''omni-progressive-delivery service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_progressive_delivery_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_progressive_delivery_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/rollout/start", "operation": "rollout_start_post"}, {"method": "GET", "path": "/api/v1/rollout/{id}/status", "operation": "rollout_id_status_get"}, {"method": "POST", "path": "/api/v1/rollout/{id}/promote", "operation": "rollout_id_promote_post"}, {"method": "POST", "path": "/api/v1/rollout/{id}/rollback", "operation": "rollout_id_rollback_post"}]
...
app = FastAPI(title="omni-progressive-delivery", version="1.0.0", lifespan=lifespan)
