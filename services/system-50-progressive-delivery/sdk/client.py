'''Async SDK client for omni-progressive-delivery.'''
...
class ProgressiveDeliveryClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-progressive-delivery:9892", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/rollout/start", payload or {})
