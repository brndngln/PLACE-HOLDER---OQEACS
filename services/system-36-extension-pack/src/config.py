'''Configuration for omni-extension-pack.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-extension-pack", alias="SERVICE_NAME")
    port: int = Field(default=9864, alias="SERVICE_PORT")
