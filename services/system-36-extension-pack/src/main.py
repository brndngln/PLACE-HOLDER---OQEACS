'''omni-extension-pack service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_extension_pack_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_extension_pack_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/extension/generate", "operation": "extension_generate_post"}, {"method": "POST", "path": "/api/v1/extension/audit-permissions", "operation": "extension_audit_permissions_post"}, {"method": "POST", "path": "/api/v1/extension/test", "operation": "extension_test_post"}]
...
app = FastAPI(title="omni-extension-pack", version="1.0.0", lifespan=lifespan)
