'''Async SDK client for omni-extension-pack.'''
...
class ExtensionPackClient:
    ...
    def __init__(self, base_url: str = "http://omni-extension-pack:9864", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/extension/generate", payload or {})
