'''omni-lifetime-reasoner service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_lifetime_reasoner_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_lifetime_reasoner_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/analyze/rust", "operation": "analyze_rust_post"}, {"method": "POST", "path": "/api/v1/analyze/cpp", "operation": "analyze_cpp_post"}]
...
app = FastAPI(title="omni-lifetime-reasoner", version="1.0.0", lifespan=lifespan)
