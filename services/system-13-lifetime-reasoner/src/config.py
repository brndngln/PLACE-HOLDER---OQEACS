'''Configuration for omni-lifetime-reasoner.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-lifetime-reasoner", alias="SERVICE_NAME")
    port: int = Field(default=9806, alias="SERVICE_PORT")
