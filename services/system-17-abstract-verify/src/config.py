'''Configuration for omni-abstract-verify.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-abstract-verify", alias="SERVICE_NAME")
    port: int = Field(default=9822, alias="SERVICE_PORT")
