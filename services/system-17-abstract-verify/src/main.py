'''omni-abstract-verify service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_abstract_verify_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_abstract_verify_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/verify/eva", "operation": "verify_eva_post"}, {"method": "POST", "path": "/api/v1/verify/wp", "operation": "verify_wp_post"}]
...
app = FastAPI(title="omni-abstract-verify", version="1.0.0", lifespan=lifespan)
