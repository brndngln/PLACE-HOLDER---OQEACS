'''Async SDK client for omni-abstract-verify.'''
...
class AbstractVerifyClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-abstract-verify:9822", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/verify/eva", payload or {})
