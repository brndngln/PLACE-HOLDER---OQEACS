'''omni-agent-memory-bus service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_agent_memory_bus_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_agent_memory_bus_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/sessions", "operation": "sessions_post"}, {"method": "GET", "path": "/api/v1/sessions/{id}", "operation": "sessions_id_get"}, {"method": "PUT", "path": "/api/v1/sessions/{id}/write", "operation": "sessions_id_write_put"}, {"method": "GET", "path": "/api/v1/sessions/{id}/subscribe", "operation": "sessions_id_subscribe_get"}]
...
app = FastAPI(title="omni-agent-memory-bus", version="1.0.0", lifespan=lifespan)
