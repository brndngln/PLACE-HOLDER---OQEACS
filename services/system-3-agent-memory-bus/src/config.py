'''Configuration for omni-agent-memory-bus.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-agent-memory-bus", alias="SERVICE_NAME")
    port: int = Field(default=9853, alias="SERVICE_PORT")
