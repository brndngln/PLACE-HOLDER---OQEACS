'''omni-bug-replay service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_bug_replay_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_bug_replay_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/replay/record", "operation": "replay_record_post"}, {"method": "POST", "path": "/api/v1/replay/play", "operation": "replay_play_post"}, {"method": "GET", "path": "/api/v1/replay/recordings", "operation": "replay_recordings_get"}]
...
app = FastAPI(title="omni-bug-replay", version="1.0.0", lifespan=lifespan)
