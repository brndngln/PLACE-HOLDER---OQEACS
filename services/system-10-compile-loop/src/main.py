'''omni-compile-loop service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_compile_loop_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_compile_loop_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/compile", "operation": "compile_post"}, {"method": "GET", "path": "/api/v1/compile/stats", "operation": "compile_stats_get"}]
...
app = FastAPI(title="omni-compile-loop", version="1.0.0", lifespan=lifespan)
