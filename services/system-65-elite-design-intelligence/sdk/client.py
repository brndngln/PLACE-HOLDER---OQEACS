'''Async SDK client for omni-elite-design-intelligence.'''
...
class EliteDesignIntelligenceClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-elite-design-intelligence:9910", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/design/analyze", payload or {})
