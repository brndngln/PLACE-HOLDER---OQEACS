'''omni-elite-design-intelligence service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_design_intelligence_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_design_intelligence_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/design/analyze", "operation": "design_analyze_post"}, {"method": "GET", "path": "/api/v1/design/{id}/status", "operation": "design_id_status_get"}, {"method": "GET", "path": "/api/v1/design/patterns", "operation": "design_patterns_get"}]
...
app = FastAPI(title="omni-elite-design-intelligence", version="1.0.0", lifespan=lifespan)
