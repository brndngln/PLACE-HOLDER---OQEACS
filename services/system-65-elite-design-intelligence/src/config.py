'''Configuration for omni-elite-design-intelligence.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-design-intelligence", alias="SERVICE_NAME")
    port: int = Field(default=9910, alias="SERVICE_PORT")
