'''Configuration for omni-admission-guard.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-admission-guard", alias="SERVICE_NAME")
    port: int = Field(default=9894, alias="SERVICE_PORT")
