'''omni-admission-guard service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_admission_guard_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_admission_guard_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/guard/validate", "operation": "guard_validate_post"}, {"method": "GET", "path": "/api/v1/guard/policies", "operation": "guard_policies_get"}, {"method": "POST", "path": "/api/v1/guard/add-policy", "operation": "guard_add_policy_post"}]
...
app = FastAPI(title="omni-admission-guard", version="1.0.0", lifespan=lifespan)
