'''omni-identity-pack service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_identity_pack_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_identity_pack_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/identity/generate", "operation": "identity_generate_post"}, {"method": "POST", "path": "/api/v1/identity/test-policy", "operation": "identity_test_policy_post"}]
...
app = FastAPI(title="omni-identity-pack", version="1.0.0", lifespan=lifespan)
