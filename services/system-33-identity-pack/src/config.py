'''Configuration for omni-identity-pack.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-identity-pack", alias="SERVICE_NAME")
    port: int = Field(default=9869, alias="SERVICE_PORT")
