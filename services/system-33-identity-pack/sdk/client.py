'''Async SDK client for omni-identity-pack.'''
...
class IdentityPackClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-identity-pack:9869", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/identity/generate", payload or {})
