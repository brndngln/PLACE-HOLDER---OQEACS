'''omni-sanitizer-orch service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_sanitizer_orch_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_sanitizer_orch_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/sanitize/run", "operation": "sanitize_run_post"}, {"method": "GET", "path": "/api/v1/sanitize/matrix", "operation": "sanitize_matrix_get"}]
...
app = FastAPI(title="omni-sanitizer-orch", version="1.0.0", lifespan=lifespan)
