'''Configuration for omni-sanitizer-orch.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-sanitizer-orch", alias="SERVICE_NAME")
    port: int = Field(default=9824, alias="SERVICE_PORT")
