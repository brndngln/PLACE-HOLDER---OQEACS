'''omni-webrtc-pack service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_webrtc_pack_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_webrtc_pack_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/webrtc/generate", "operation": "webrtc_generate_post"}, {"method": "POST", "path": "/api/v1/webrtc/test", "operation": "webrtc_test_post"}]
...
app = FastAPI(title="omni-webrtc-pack", version="1.0.0", lifespan=lifespan)
