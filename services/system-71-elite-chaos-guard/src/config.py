'''Configuration for omni-elite-chaos-guard.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-chaos-guard", alias="SERVICE_NAME")
    port: int = Field(default=9916, alias="SERVICE_PORT")
