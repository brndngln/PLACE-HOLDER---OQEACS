'''omni-elite-chaos-guard service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_chaos_guard_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_chaos_guard_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/chaos/start", "operation": "chaos_start_post"}, {"method": "GET", "path": "/api/v1/chaos/{id}/status", "operation": "chaos_id_status_get"}, {"method": "POST", "path": "/api/v1/chaos/{id}/stop", "operation": "chaos_id_stop_post"}]
...
app = FastAPI(title="omni-elite-chaos-guard", version="1.0.0", lifespan=lifespan)
