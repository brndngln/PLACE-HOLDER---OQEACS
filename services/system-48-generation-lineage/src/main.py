'''omni-generation-lineage service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_generation_lineage_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_generation_lineage_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/generation-lineage/register", "operation": "generation_lineage_register_post"}, {"method": "GET", "path": "/api/v1/generation-lineage/{task_id}", "operation": "generation_lineage_task_id_get"}, {"method": "GET", "path": "/api/v1/generation-lineage/search", "operation": "generation_lineage_search_get"}]
...
app = FastAPI(title="omni-generation-lineage", version="1.0.0", lifespan=lifespan)
