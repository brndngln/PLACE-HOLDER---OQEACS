'''Configuration for omni-generation-lineage.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-generation-lineage", alias="SERVICE_NAME")
    port: int = Field(default=9888, alias="SERVICE_PORT")
