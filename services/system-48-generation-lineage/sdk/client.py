'''Async SDK client for omni-generation-lineage.'''
...
class GenerationLineageClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-generation-lineage:9888", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/generation-lineage/register", payload or {})
