'''omni-dep-trust service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_dep_trust_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_dep_trust_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/trust/score", "operation": "trust_score_post"}, {"method": "POST", "path": "/api/v1/trust/batch", "operation": "trust_batch_post"}, {"method": "GET", "path": "/api/v1/trust/policy", "operation": "trust_policy_get"}]
...
app = FastAPI(title="omni-dep-trust", version="1.0.0", lifespan=lifespan)
