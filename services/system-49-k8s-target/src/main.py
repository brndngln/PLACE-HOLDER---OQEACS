'''omni-k8s-target service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_k8s_target_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_k8s_target_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/k8s/generate-helm", "operation": "k8s_generate_helm_post"}, {"method": "POST", "path": "/api/v1/k8s/generate-kustomize", "operation": "k8s_generate_kustomize_post"}, {"method": "POST", "path": "/api/v1/k8s/validate", "operation": "k8s_validate_post"}, {"method": "POST", "path": "/api/v1/k8s/deploy", "operation": "k8s_deploy_post"}]
...
app = FastAPI(title="omni-k8s-target", version="1.0.0", lifespan=lifespan)
