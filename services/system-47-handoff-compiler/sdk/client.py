'''Async SDK client for omni-handoff-compiler.'''
...
class HandoffCompilerClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-handoff-compiler:9887", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/handoff/generate", payload or {})
