'''omni-handoff-compiler service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_handoff_compiler_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_handoff_compiler_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/handoff/generate", "operation": "handoff_generate_post"}, {"method": "GET", "path": "/api/v1/handoff/{id}/download", "operation": "handoff_id_download_get"}]
...
app = FastAPI(title="omni-handoff-compiler", version="1.0.0", lifespan=lifespan)
