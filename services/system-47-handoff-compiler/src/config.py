'''Configuration for omni-handoff-compiler.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-handoff-compiler", alias="SERVICE_NAME")
    port: int = Field(default=9887, alias="SERVICE_PORT")
