'''omni-elite-test-signal-fusion service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_elite_test_signal_fusion_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_elite_test_signal_fusion_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/signals/fuse", "operation": "signals_fuse_post"}, {"method": "GET", "path": "/api/v1/signals/{id}/status", "operation": "signals_id_status_get"}, {"method": "GET", "path": "/api/v1/signals/history", "operation": "signals_history_get"}]
...
app = FastAPI(title="omni-elite-test-signal-fusion", version="1.0.0", lifespan=lifespan)
