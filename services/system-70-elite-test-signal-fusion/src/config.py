'''Configuration for omni-elite-test-signal-fusion.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-elite-test-signal-fusion", alias="SERVICE_NAME")
    port: int = Field(default=9915, alias="SERVICE_PORT")
