'''Async SDK client for omni-elite-test-signal-fusion.'''
...
class EliteTestSignalFusionClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-elite-test-signal-fusion:9915", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/signals/fuse", payload or {})
