'''omni-patch-tree service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_patch_tree_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_patch_tree_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/search/start", "operation": "search_start_post"}, {"method": "GET", "path": "/api/v1/search/{id}/status", "operation": "search_id_status_get"}, {"method": "GET", "path": "/api/v1/search/{id}/best-patch", "operation": "search_id_best_patch_get"}, {"method": "POST", "path": "/api/v1/search/{id}/prune", "operation": "search_id_prune_post"}]
...
app = FastAPI(title="omni-patch-tree", version="1.0.0", lifespan=lifespan)
