'''Configuration for omni-contract-synth.'''
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="omni-contract-synth", alias="SERVICE_NAME")
    port: int = Field(default=9804, alias="SERVICE_PORT")
