'''omni-contract-synth service entrypoint.'''
...
REQUEST_COUNT = Counter(
    "omni_contract_synth_requests_total",
    "Total requests",
    ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "omni_contract_synth_request_seconds",
    "Request latency",
    ["method", "endpoint"],
)

ENDPOINTS: list[dict[str, str]] = [{"method": "POST", "path": "/api/v1/contracts/openapi", "operation": "contracts_openapi_post"}, {"method": "POST", "path": "/api/v1/contracts/protobuf", "operation": "contracts_protobuf_post"}, {"method": "POST", "path": "/api/v1/contracts/validate", "operation": "contracts_validate_post"}]
...
app = FastAPI(title="omni-contract-synth", version="1.0.0", lifespan=lifespan)
