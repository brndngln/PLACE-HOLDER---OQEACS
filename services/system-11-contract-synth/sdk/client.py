'''Async SDK client for omni-contract-synth.'''
...
class ContractSynthClient:
    '''Simple async SDK client for inter-service communication.'''

    def __init__(self, base_url: str = "http://omni-contract-synth:9804", timeout: float = 30.0):
    ...
    async def primary(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        return await self.request("POST", "/api/v1/contracts/openapi", payload or {})
