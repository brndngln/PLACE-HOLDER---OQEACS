...
SERVICES: list[ServiceDef] = [
    ...
    ServiceDef(
        ...
        health_path="/-/health/ready/", port=9000,
    ...
    ServiceDef(
        ...
        health_path="/api/v1/status/runtimeinfo", port=9090,
    ...
    ServiceDef(
        ...
        health_path="/health", port=9331,
        container="omni-secret-rotation",
        depends_on=[2],
